...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'DiffusionWeight'
        db.delete_table(u'crud_diffusionweight')

        # Deleting model 'DiffusionDelay'
        db.delete_table(u'crud_diffusiondelay')


    def backwards(self, orm):
        # Adding model 'DiffusionWeight'
        db.create_table(u'crud_diffusionweight', (
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(related_name='weights_from', to=orm['crud.UserAccount'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('weight', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('receiver', self.gf('django.db.models.fields.related.ForeignKey')(related_name='weights_to', to=orm['crud.UserAccount'])),
        ))
        db.send_create_signal(u'crud', ['DiffusionWeight'])

        # Adding model 'DiffusionDelay'
        db.create_table(u'crud_diffusiondelay', (
            ('delay', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(related_name='delays_from', to=orm['crud.UserAccount'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('receiver', self.gf('django.db.models.fields.related.ForeignKey')(related_name='delays_to', to=orm['crud.UserAccount'])),
        ))
        db.send_create_signal(u'crud', ['DiffusionDelay'])
