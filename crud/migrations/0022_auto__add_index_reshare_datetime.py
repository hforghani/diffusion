...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Reshare', fields ['datetime']
        db.create_index(u'crud_reshare', ['datetime'])


    def backwards(self, orm):
        # Removing index on 'Reshare', fields ['datetime']
        db.delete_index(u'crud_reshare', ['datetime'])
