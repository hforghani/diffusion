...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Meme.first_time'
        db.add_column(u'crud_meme', 'first_time',
    ...
    def backwards(self, orm):
        # Deleting field 'Meme.first_time'
        db.delete_column(u'crud_meme', 'first_time')

        # Adding field 'Reshare.user'
        user_id = orm.UserAccount.objects.all()[0].id
        db.add_column(u'crud_reshare', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=user_id, to=orm['crud.UserAccount']),
                      keep_default=False)
