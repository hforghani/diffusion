...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reshare.user'
        db.add_column(u'crud_reshare', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='parent_reshares', null=True, to=orm['crud.UserAccount']),
                      keep_default=False)

        # Adding field 'Reshare.ref_user'
        db.add_column(u'crud_reshare', 'ref_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children_reshares', null=True, to=orm['crud.UserAccount']),
                      keep_default=False)

        # Adding field 'Reshare.ref_datetime'
        db.add_column(u'crud_reshare', 'ref_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reshare.user'
        db.delete_column(u'crud_reshare', 'user_id')

        # Deleting field 'Reshare.ref_user'
        db.delete_column(u'crud_reshare', 'ref_user_id')

        # Deleting field 'Reshare.ref_datetime'
        db.delete_column(u'crud_reshare', 'ref_datetime')
