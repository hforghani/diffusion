...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'crud_post', 'url', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Post.url'
        db.alter_column(u'crud_post', 'url', self.gf('django.db.models.fields.URLField')(max_length=500, null=True))
