...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserTermFreq.datetime'
        db.delete_column(u'crud_usertermfreq', 'datetime')

        # Adding field 'UserTermFreq.from_datetime'
        db.add_column(u'crud_usertermfreq', 'from_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'UserTermFreq.to_datetime'
        db.add_column(u'crud_usertermfreq', 'to_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'UserTermFreq.datetime'
        db.add_column(u'crud_usertermfreq', 'datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Deleting field 'UserTermFreq.from_datetime'
        db.delete_column(u'crud_usertermfreq', 'from_datetime')

        # Deleting field 'UserTermFreq.to_datetime'
        db.delete_column(u'crud_usertermfreq', 'to_datetime')
    ...
    models = {
        ...
        u'crud.dataentry': {
            ...
            'comments_message': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'comments_progress': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'finished': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'friends_message': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'friends_progress': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'likes_message': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'likes_progress': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'nets_message': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'nets_progress': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'posts_message': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'posts_progress': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'reshares_message': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'reshares_progress': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'started': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'users_message': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'users_progress': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        u'crud.diffusionparam': {
            'Meta': {'object_name': 'DiffusionParam'},
            'delay': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'receiver': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'params_to'", 'to': u"orm['crud.UserAccount']"}),
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'params_from'", 'to': u"orm['crud.UserAccount']"}),
        ...
        u'crud.projectmembership': {
            'Meta': {'object_name': 'ProjectMembership'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['crud.Project']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['crud.UserAccount']"})
        },
        u'crud.reshare': {
        ...
        u'crud.usertermfreq': {
            'Meta': {'object_name': 'UserTermFreq'},
            'frequency': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'from_datetime': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'term': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['crud.Keyword']"}),
            'to_datetime': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['crud.UserAccount']"})
        },
        u'crud.work': {
