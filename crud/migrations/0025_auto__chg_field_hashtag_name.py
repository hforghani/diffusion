...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Hashtag.name'
        db.alter_column(u'crud_hashtag', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Hashtag.name'
        db.alter_column(u'crud_hashtag', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))
