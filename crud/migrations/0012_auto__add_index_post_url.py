...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Post', fields ['url']
        db.create_index(u'crud_post', ['url'])


    def backwards(self, orm):
        # Removing index on 'Post', fields ['url']
        db.delete_index(u'crud_post', ['url'])
    ...
    models = {
        ...
        u'crud.post': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'text': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'url': ('django.db.models.fields.URLField', [], {'db_index': 'True', 'max_length': '500', 'null': 'True', 'blank': 'True'})
        },
        u'crud.postmeme': {
