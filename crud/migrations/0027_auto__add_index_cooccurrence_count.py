...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'CoOccurrence', fields ['count']
        db.create_index(u'crud_cooccurrence', ['count'])


    def backwards(self, orm):
        # Removing index on 'CoOccurrence', fields ['count']
        db.delete_index(u'crud_cooccurrence', ['count'])
