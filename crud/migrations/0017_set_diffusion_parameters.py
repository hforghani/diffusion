...
class Migration(DataMigration):
    def forwards(self, orm):
        diff_params = {}
        for obj in orm.DiffusionWeight.objects.iterator():
            diff_params[(obj.sender_id, obj.receiver_id)] = orm.DiffusionParam(sender_id=obj.sender_id,
                                                                              receiver_id=obj.receiver_id,
                                                                              weight=obj.weight)
        for obj in orm.DiffusionDelay.objects.iterator():
            key = (obj.sender_id, obj.receiver_id)
            if key in diff_params:
                diff_params[key].delay = obj.delay
            else:
                diff_params[key] = orm.DiffusionParam(sender_id=obj.sender_id, receiver_id=obj.receiver_id,
                                                     weight=None, delay=obj.delay)
        orm.DiffusionParam.objects.bulk_create(diff_params.values())

    def backwards(self, orm):
        diff_weights = []
        diff_delays = []
        for obj in orm.DiffusionParam.objects.iterator():
            diff_weights.append(
                orm.DiffusionWeight(sender_id=obj.sender_id, receiver_id=obj.receiver_id, weight=obj.weight))
            diff_delays.append(
                orm.DiffusionDelay(sender_id=obj.sender_id, receiver_id=obj.receiver_id, delay=obj.delay))
        orm.DiffusionWeight.objects.bulk_create(diff_weights)
        orm.DiffusionDelay.objects.bulk_create(diff_delays)
    ...
    models = {
        ...
        u'crud.cooccurrence': {
            ...
            'term1': (
                ...
                {'related_name': "'+'", 'to': u"orm['crud.Keyword']"}),
            'term2': (
                'django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['crud.Keyword']"})
        },
        u'crud.diffusiondelay': {
            ...
            'receiver': ('django.db.models.fields.related.ForeignKey', [],
                         {'related_name': "'delays_to'", 'to': u"orm['crud.UserAccount']"}),
            'sender': ('django.db.models.fields.related.ForeignKey', [],
                       {'related_name': "'delays_from'", 'to': u"orm['crud.UserAccount']"})
        },
        u'crud.diffusionparam': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'receiver': ('django.db.models.fields.related.ForeignKey', [],
                         {'related_name': "'params_to'", 'to': u"orm['crud.UserAccount']"}),
            'sender': ('django.db.models.fields.related.ForeignKey', [],
                       {'related_name': "'params_from'", 'to': u"orm['crud.UserAccount']"}),
        ...
        u'crud.diffusionweight': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'receiver': ('django.db.models.fields.related.ForeignKey', [],
                         {'related_name': "'weights_to'", 'to': u"orm['crud.UserAccount']"}),
            'sender': ('django.db.models.fields.related.ForeignKey', [],
                       {'related_name': "'weights_from'", 'to': u"orm['crud.UserAccount']"}),
            'weight': ('django.db.models.fields.FloatField', [], {'default': '0'})
        },
        u'crud.education': {
        ...
        u'crud.friendship': {
            ...
            'user1': ('django.db.models.fields.related.ForeignKey', [],
                      {'related_name': "'+'", 'to': u"orm['crud.UserAccount']"}),
            'user2': (
                'django.db.models.fields.related.ForeignKey', [],
                {'related_name': "'+'", 'to': u"orm['crud.UserAccount']"})
        },
        u'crud.group': {
            ...
            'social_net': ('django.db.models.fields.related.ForeignKey', [],
                           {'to': u"orm['crud.SocialNet']", 'null': 'True', 'blank': 'True'}),
        ...
        u'crud.person': {
            ...
            'educations': ('django.db.models.fields.related.ManyToManyField', [],
                           {'symmetrical': 'False', 'to': u"orm['crud.Education']", 'null': 'True', 'blank': 'True'}),
            'first_name': (
                'django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            ...
            'location': (
                'django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'works': ('django.db.models.fields.related.ManyToManyField', [],
                      {'symmetrical': 'False', 'to': u"orm['crud.Work']", 'null': 'True', 'blank': 'True'})
        },
        u'crud.post': {
        ...
        u'crud.reshare': {
            ...
            'post': (
                'django.db.models.fields.related.ForeignKey', [],
                {'related_name': "'parents'", 'to': u"orm['crud.Post']"}),
            'reshared_post': ('django.db.models.fields.related.ForeignKey', [],
                              {'related_name': "'children'", 'null': 'True', 'to': u"orm['crud.Post']"})
        },
        u'crud.socialnet': {
        ...
        u'crud.topic': {
            ...
            'users': ('django.db.models.fields.related.ManyToManyField', [],
                      {'to': u"orm['crud.UserAccount']", 'symmetrical': 'False'})
        },
        u'crud.useraccount': {
            ...
            'person': ('django.db.models.fields.related.ForeignKey', [],
                       {'to': u"orm['crud.Person']", 'null': 'True', 'blank': 'True'}),
