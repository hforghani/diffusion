...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DiffusionParam.delay'
        db.alter_column(u'crud_diffusionparam', 'delay', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'DiffusionParam.delay'
        db.alter_column(u'crud_diffusionparam', 'delay', self.gf('django.db.models.fields.IntegerField')())
