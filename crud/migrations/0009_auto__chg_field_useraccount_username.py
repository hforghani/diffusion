...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'crud_useraccount', 'username', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'UserAccount.username'
        db.alter_column(u'crud_useraccount', 'username', self.gf('django.db.models.fields.CharField')(max_length=50))
