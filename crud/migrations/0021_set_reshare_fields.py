...
class Migration(DataMigration):
    def forwards(self, orm):
        i = 0
        print 'settings values of new Reshare fields ...'
        for resh in orm.Reshare.objects.iterator():
    ...
    models = {
        ...
        u'crud.reshare': {
            ...
            'ref_user': ('django.db.models.fields.related.ForeignKey', [],
                         {'blank': 'True', 'related_name': "'children_reshares'", 'null': 'True',
                          'to': u"orm['crud.UserAccount']"}),
            'reshared_post': ('django.db.models.fields.related.ForeignKey', [],
                              {'related_name': "'children'", 'null': 'True', 'to': u"orm['crud.Post']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [],
                     {'blank': 'True', 'related_name': "'parent_reshares'", 'null': 'True',
                      'to': u"orm['crud.UserAccount']"})
        },
        u'crud.socialnet': {
